...
public partial class UserViewProduct1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlDataAdapter adp;
    DataTable dt;
    ...
    protected void LinkButton1_Click(object sender, EventArgs e)
    {
        try 
        {
          ...
          /*  int pid = int.Parse(Request.QueryString.Get("pid"));
            adp = new SqlDataAdapter("select r1.uname,r1.srating,r1.rrating,r1.erating,r1.urating from revtable r1,rctable r2  where r1.pid=r2.pid and r1.pid=@pid order by rcount desc ", con);  // change coding
            adp.SelectCommand.Parameters.AddWithValue("pid", pid);
            dt=new DataTable ();
            adp.Fill(dt);
            GridView1.DataSource = dt;
