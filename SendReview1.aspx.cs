...
public partial class SendReview1 : System.Web.UI.Page
{
    SqlConnection con;
    SqlCommand cmd;
    SqlDataReader rs;
    ...
    protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "rr")
            {
                ...
                Response.Redirect("SendReview2.aspx?pid=" + pid);
            }

            else if (e.CommandName == "rer")
            {
                int pid = int.Parse(e.CommandArgument.ToString());
                Response.Redirect("UserViewRelatedReview.aspx?pid=" + pid);
            }
        }
        catch (Exception ex)
        {
